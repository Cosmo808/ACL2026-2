...
homog2norm = {}
[homog2norm.update({g: c for g in homog}) for c, homog in homoglyphs.items()]


_homog_translate_table = str.maketrans(homog2norm)

def normalise_homoglyphs(text):
    return text.translate(_homog_translate_table)
