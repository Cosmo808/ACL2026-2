...
from utils.boundary_creator import get_boundary_creator
...
class LMOrderedIterator(object):
    def __init__(self, data, bsz, tgt_len, ext_len, vocab,
        ...
        self.boundaries = boundary_creator.get_boundaries(txt=self.txt, tensor=self.data)
    ...
    def get_batch(self, i):
        ...
        target = data[-seq_len:]
        if data.shape[0] != self.tgt_len + self.ext_len:
            data = data[:-1]
