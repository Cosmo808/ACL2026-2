...
class TkLM(nn.Module):
    ...
    def forward(self, premise=None, hypothesis=None, labels=None, **kwargs):
        ...
        #
        # # Total loss
        # aux_loss = snn_loss * 0.2 + reset_loss
...
def prepare_model(model_args, adapter_args, num_labels, label_list, vocab, data_args):
    ...
    if adapter_args.lora:
        ...
        peft_config = LoraConfig(
            lora_alpha=adapter_args.lora_alpha, lora_dropout=adapter_args.lora_dropout, r=adapter_args.lora_rank, target_modules=["query", "value"],
